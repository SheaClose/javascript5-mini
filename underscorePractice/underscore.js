...
// console.log([...inviteList1, ...inviteList2].filter((c,i,a)=>a.indexOf(c)==i));
...
// console.log(friendsOfBetty.filter(c=>friendsOfJim.includes(c)))
...
let tempObj = {}
purchases.forEach(c=>{
  if(!tempObj[c.company]){
    tempObj[c.company] = [c]
  }
  else {
    tempObj[c.company].push(c)
  }
})
console.log(tempObj)
